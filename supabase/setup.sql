-- =============================================================================
-- Double Slash — Task Board schema + RLS + seed
...
insert into public.tasks (id, title, group_id, owner_id, status_id, priority_id, due, notes, github, sort_order) values
  ...
  ('PRD-002', 'Write Double Slash manifesto (Lean Startup-style)',                      'product',     'tal',     'todo',        'p1', '2026-05-05', 'Pillars: test-oriented, experimental, community-connected. Gates MKT-002 + MKT-003.',           '',         20),
  ...
  ('FISH-003','Spec the // install bundle for Claude Desktop / Cursor / ChatGPT Desktop','methodology', 'tal',     'todo',        'p0', '2026-05-12', 'Per-tool install plumbing — Claude (CLAUDE.md), Cursor (.cursorrules), ChatGPT (Custom Instructions). See technical-research-double-slash-stack.md. Depends on FISH-002.', '',         30),
