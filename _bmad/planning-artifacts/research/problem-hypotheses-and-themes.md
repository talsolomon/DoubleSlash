...
| **C — operating model** | ≥50% of leads say their process doesn't match how they actually work now AND volunteer AI as the reason without prompting | Leads report Agile-with-AI is working fine; or FISH vocabulary doesn't resonate |
