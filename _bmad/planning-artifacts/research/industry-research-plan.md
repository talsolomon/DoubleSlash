...
Every cited source lands in a single file: `_bmad/planning-artifacts/research/desk-citations.md`. One row per citation:
...
1. **Desk research citation file** — `_bmad/planning-artifacts/research/desk-citations.md` with every cited source, extracted data point, and theme mapping.
