...
- [ ] **Redaction ruleset.** PRD specifies the categories (email, phone, keys, tokens, SSN, client names); the exact patterns are a dev-handoff detail. Draft a `redaction-rules.md` under `planning/` during implementation.
